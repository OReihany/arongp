...
export class Introduce extends PureComponent {
	...
	render() {
		...
		return <div className={styles.introduce} style={(language==='fa') ? {background: `url(${require("../../symbols/top-slider/top-slider-fa.png").default}) no-repeat`} :{background: `url(${require("../../symbols/top-slider/top-slider.png").default}) no-repeat`} }>
