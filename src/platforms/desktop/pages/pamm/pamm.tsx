...
import {MoneyManager} from "./money-manager/money-manager";

declare const window: any;

@Observer([])
export class Pamm extends PureComponent{
	...
	render() {
		...
		return <Fragment>
			<TopMenu/>
			<TopSlider style={display} title={__('Aron Groups PAMM Acount')} key={0}/>
			<Introduce/>
			<MoneyManager/>
			<PaymentMethods/>
			<Footer />
