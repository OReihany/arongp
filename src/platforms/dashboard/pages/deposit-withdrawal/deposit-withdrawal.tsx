...
import styles from './deposit-withdrawal.module.scss';
import {Menu} from "../common/menu/menu";
import {Introduce} from "../common/page-introduce/introduce";
import {DepositWithdrawalTable} from "./main-banner/deposit-withdrawal-table";
	...
	return <Fragment>
		{
			(isLogin) ? <div className={styles.main}>
				<Menu roles={roles} role={role} index={2}/>
				<div className={styles.mainContent}>
					<Introduce title='مدیریت واریز برداشت'/>
